...
# Download the sounds
download_sounds_freesound(queryText="trumpet", tag="single-note", duration=10, API_Key="dCvdtqvTd7A4WhnDF3qSkTZafXKxVqQIxlCM85KR", outputDir ="./testDownload", topNResults = 5, featureExt ='.json')
download_sounds_freesound(queryText="violin", tag="single-note", duration=10, API_Key="dCvdtqvTd7A4WhnDF3qSkTZafXKxVqQIxlCM85KR", outputDir ="./testDownload", topNResults = 5, featureExt ='.json')
download_sounds_freesound(queryText="flute", tag="single-note", duration=10, API_Key="dCvdtqvTd7A4WhnDF3qSkTZafXKxVqQIxlCM85KR", outputDir ="./testDownload", topNResults = 5, featureExt ='.json')
